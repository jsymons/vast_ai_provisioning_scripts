...
CHECKPOINT_MODELS=(
    ...
    "https://civitai.com/api/download/models/2668826?type=Model&format=SafeTensor&size=pruned&fp=fp16"
    "https://civitai.com/api/download/models/2641213?type=Model&format=SafeTensor&size=full&fp=fp16"
    "https://civitai.com/api/download/models/2584915?type=Model&format=SafeTensor&size=pruned&fp=fp16"
)
...
SAMS_MODELS=(
    "https://huggingface.co/MIUProject/VNCCS/resolve/main/models/sams/sam_vit_b_01ec64.pth?download=true"
)
...
CONTROLNET_MODELS=(
    "https://huggingface.co/MIUProject/VNCCS/resolve/main/models/controlnet/SDXL/AnytestV4.safetensors?download=true"
    "https://huggingface.co/MIUProject/VNCCS/resolve/main/models/controlnet/SDXL/IllustriousXL_openpose.safetensors?download=true"
)
